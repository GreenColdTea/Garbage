...
class CreditsState extends MusicBeatState
{
   ...
   var friends:FlxSprite;
	...
	override function create()
	{
		...
		bg = new FlxSprite().loadGraphic(Paths.image('credits/night/bg'));
      bg.scrollFactor.x = 0;
		bg.scrollFactor.y = 0;
		bg.screenCenter();
      ...
      Tstars = new FlxSprite().loadGraphic(Paths.image('credits/night/stars'));
      Tstars.scrollFactor.x = 0;
		Tstars.scrollFactor.y = 0;
		Tstars.screenCenter();
		Tstars.antialiasing = true;
      add(Tstars);

      friends = new FlxSprite().loadGraphic(Paths.image('credits/night/uwu'));
      friends.scrollFactor.x = 0;
		friends.scrollFactor.y = 0;
		friends.screenCenter();
